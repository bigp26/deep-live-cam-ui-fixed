...
def create_source_target_popup(
    ...
    scrollable_frame = ctk.CTkScrollableFrame(
        POPUP, width=POPUP_SCROLL_WIDTH[0], height=POPUP_SCROLL_HEIGHT
    )
...
def check_and_ignore_nsfw(target, destroy: Callable = None) -> bool:
    ...
    return check_nsfw(target)

if __name__ == '__main__':
    print('This module is intended to be imported and initialized via the init() function.')
